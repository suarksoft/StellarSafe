-- ========================================
-- StellarSafe Complete Database Schema
-- ========================================
...
('AQUA', 'GBNZILSTVQZ4R7IKQDGHYGY2QXL5QOFJYQMXPKWRRM5PAV7Y4M67AQUA', 
 'aqua.network', 'AQUA token', 
 'verified', 'SAFE', 0, NOW(), 'StellarSafe'),
('yXLM', 'GARDNV3Q7YGT4AKSDF25LT32YSCCW4EV22Y2TV3I2PU2MMXJTEDL5T55', 
 'ultra-stellar.org', 'Yield XLM', 
 'verified', 'LOW', 5, NOW(), 'StellarSafe');

-- Insert sample blacklisted assets
INSERT INTO blacklisted_assets (
  asset_code, issuer_address, reason, threat_level, 
  verified_scam, reported_by
) VALUES
('USDC', 'GFAKE1111111111111111111111111111111111111111111111111', 
 'Fake USDC', 'CRITICAL', true, 'Community'),
('BTC', 'GFAKE2222222222222222222222222222222222222222222222222', 
 'Fake BTC', 'HIGH', true, 'StellarSafe');

-- Insert sample verified contracts
INSERT INTO verified_contracts (
  contract_id, network, verified, checks,
  wasm_hash, wasm_size, source_hash, source_files,
  git_commit, git_remote, git_branch,
  rust_version, soroban_version, contract_name, verified_by
) VALUES
(
  'CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  'testnet', true,
  '[
    {"name":"WASM_MATCH","passed":true,"message":"WASM matches"},
    {"name":"PUBLIC_SOURCE","passed":true,"message":"Source accessible"},
    {"name":"SOURCE_FILES","passed":true,"message":"5 files"},
    {"name":"BUILD_ENV","passed":true,"message":"Valid build"}
  ]'::jsonb,
  'abc123', 45678, 'def456',
  ARRAY['lib.rs', 'contract.rs'],
  'a1b2c3d4', 'https://github.com/stellar/example',
  'main', 'rustc 1.70.0', 'soroban 20.0.0',
  'example_token', 'stellarsafe-cli'
),
(
  'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC',
  'testnet', true,
  '[
    {"name":"WASM_MATCH","passed":true,"message":"Native XLM SAC"},
    {"name":"PUBLIC_SOURCE","passed":true,"message":"Stellar official"},
    {"name":"BUILD_ENV","passed":true,"message":"Official build"}
  ]'::jsonb,
  'native_xlm', 12345, 'native',
  ARRAY['contract.rs'],
  'stellar', 'https://github.com/stellar/soroban-examples',
  'main', 'rustc 1.70.0', 'soroban 20.0.0',
  'native_xlm', 'stellar-official'
);

-- Insert sample contract metadata
INSERT INTO contract_metadata (
  contract_id, network, name, description,
  website_url, documentation_url, license
) VALUES
(
  'CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
  'testnet', 'Example Token', 'Test token contract',
  'https://example.org', 'https://docs.example.org', 'MIT'
),
(
  'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC',
  'testnet', 'Native XLM', 'Stellar native asset contract',
  'https://stellar.org', 'https://developers.stellar.org', 'Apache-2.0'
);
...
DO $$
BEGIN
  RAISE NOTICE 'StellarSafe database schema created successfully!';
  RAISE NOTICE 'Tables: 11 created';
  RAISE NOTICE 'Indexes: 21 created';
  RAISE NOTICE 'Functions: 3 created';
  RAISE NOTICE 'RLS Policies: 6 enabled';
